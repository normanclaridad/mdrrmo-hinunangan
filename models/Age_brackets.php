...
class Age_brackets extends Models {
    ...
    public function __construct() {
        ...
        $this->table = 'age_brackets';
	}

	public function getWhere( $where = '', $sortBy = 'age_from ASC') {
    ...
    public function getAgeBrackets( $where = '', $sortBy = 'age_from ASC') {
		$sql = "SELECT * 
                FROM $this->table 
                WHERE 1 ";
