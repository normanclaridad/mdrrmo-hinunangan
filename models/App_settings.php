...
class App_settings extends Models {
	...
	public function getJoinWhere($where = '', $limit = 500) {
		$sql = "SELECT b.*, cm.citymunDesc, p.provDesc  FROM barangays b
                JOIN city_mun cm ON cm.cityMunCode = b.cityMunCode
                JOIN provinces p ON p.provCode = b.provCode
                WHERE $where
                ORDER BY brgyDesc, cityMunDesc, provDEsc
                LIMIT $limit
                ";	
