...
class Evacuees extends Models {
    ...
    public function getEvacuees( $where = '', $sortBy = 'e.id ASC') {
		$sql = "SELECT * FROM evacuees e
                JOIN barangays b ON b.id = e.baragay_id
                JOIN age_brackets ab ON ab.id = e.age_bracket_id
                WHERE 1 ";
