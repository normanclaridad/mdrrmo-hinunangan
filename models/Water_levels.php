...
class Water_levels extends Models {
    ...
    public function getWaterLevels( $where = '', $sortBy = 'wl.id ASC') {
		$sql = "SELECT wl.*, b.brgyDesc 
                FROM water_levels wl
                JOIN barangays b ON b.id = wl.baragay_id
                WHERE 1 ";
