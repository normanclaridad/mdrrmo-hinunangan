...
class Sitrep_bridges extends Models {
    ...
    public function getSitrepBridges($where = '') {
        
		$sql = "SELECT sb.*, b.name AS bridge_name 
                FROM sitrep_bridges sb
                JOIN bridges b ON b.id = sb.bridge_id
                WHERE 1 ";
