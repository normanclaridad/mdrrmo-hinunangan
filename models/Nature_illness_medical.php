...
class Nature_illness_medical extends Models {
    ...
    public function __construct() {
        ...
        $this->table = 'nature_illness_medical';
	}
    ...
    public function getBridges( $where = '', $sortBy = 'br.name ASC') {
		$sql = "SELECT br.*, b.brgyDesc 
                FROM $this->table br
