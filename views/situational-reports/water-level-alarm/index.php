...
$helpers = new Helpers();
define('PAGE_TITLE', 'Water Level Alarm');
                    ...
                    <div class="modal-body">
                        <form id="frm-crud" method="post" data-parsley-validate="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="from" name="from" placeholder="0" required>
                            </div>
                            <div class="form-group">
                                <label for="to">To</label>
                                <input type="number" class="form-control" id="to" name="to" placeholder="0" required>
                            </div>
                            <div class="form-group">
                                <label for="alarm_level">Alarm Level</label>
                                <input type="text" class="form-control" id="alarm_level" name="alarm_level" placeholder="Alarm level" required>
                            </div>
...
<script>
    $(document).ready(function(){
        var table = $('#tbl-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/water-level-alarm/get.php',
                type: 'POST',
                data:   function ( d ) {
                    return $.extend( {}, d, {
                        //'action' : getAction()
        ...
        $('#btn-save').click(function(){
            ...
            $.ajax({
                url : '<?php echo BASE_URL ?>/api/water-level-alarm/dml.php',
                type : 'post',
    ...
    $(document).on('click', 'a.btn-edit', function(){
        ...
        $('#id').val($(this).data('id'));
        $('#from').val($(this).data('level-from'));
        $('#to').val($(this).data('level-to'));
        $('#alarm_level').val($(this).data('alarm-level'));
