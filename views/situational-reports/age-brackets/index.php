...
$helpers = new Helpers();
define('PAGE_TITLE', 'Age Brackets');
...
<script>
    $(document).ready(function(){
        var table = $('#tbl-data').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo BASE_URL ?>/api/age-brackets/get.php',
                type: 'POST',
                data:   function ( d ) {
                    return $.extend( {}, d, {
                        //'action' : getAction()
        ...
        $('#btn-save').click(function(){
            ...
            $.ajax({
                url : '<?php echo BASE_URL ?>/api/age-brackets/dml.php',
                type : 'post',
    ...
    $(document).on('click', 'a.btn-edit', function(){
        ...
        $('#id').val($(this).data('id'));
        $('#from').val($(this).data('age-from'));
        $('#to').val($(this).data('age-to'));
